...
class Ui_PHYMOBAT(object):
    def setupUi(self, PHYMOBAT):
        ...
        self.gridLayout.addWidget(self.lineEdit_year_images, 2, 1, 1, 1)
    ...
    def retranslateUi(self, PHYMOBAT):
        ...
        self.lineEdit_year_images.setToolTip(_translate("PHYMOBAT", "Année des images à télécharger", None))
